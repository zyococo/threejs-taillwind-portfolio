...
const About = () => {
  return (
    <>
      ...
      >
        私は何事に対しても計画性、主体性をもち全力でタスクに向き合い、最後までやり切る力があります。やり遂げた成果としましては、大きく分けて３つあります。大学休学期間中のフィリピン留学で定めた目標TOEIC500点スコアアップを達成したこと、大学卒業後にバケットリストの1つでもあった英語圏の訓練学校受験に合格したこと、またとある英語系ユーチューバーの数百人規模のイベントで開催されたコンペティションで個人で優勝したことです。
      </motion.p>
